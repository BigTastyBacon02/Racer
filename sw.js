// SW v1
const CACHE='transam-racer-v1';
const ASSETS=['./','./index.html','./manifest.webmanifest?v=1','./assets/icons/icon-192.png','./assets/icons/icon-512.png','./assets/ui/bg.png','./assets/cars/transam.png','./assets/cars/fiat.png'];
