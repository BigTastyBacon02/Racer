// SW v3 (cache bump)
const CACHE='transam-racer-v1_2';
const ASSETS=['./','./index.html','./manifest.webmanifest?v=3','./assets/icons/icon-192.png','./assets/icons/icon-512.png','./assets/ui/bg.png','./assets/cars/transam.png','./assets/cars/fiat.png'];
